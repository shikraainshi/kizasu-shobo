...
export default function CafePage() {
  ...
  return (
    <div className="bg-[#fdfcf8] pb-24 overflow-hidden">
      ...
      <section className="py-14 md:py-24 container mx-auto px-6">
        <motion.div 
      ...
      <section className="py-14 md:py-24 bg-wakaba/10 relative">
          ...
          >
            ...
            <div className="pt-8">
              <div className="flex items-center gap-4 text-accent/40 font-serif italic text-sm">
                <Wind size={20} />
                <span>歴史ある奈良の街で、本とともに、静かな時間をお楽しみください</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 md:py-32 container mx-auto px-6">
        <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-sm shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-border/40 overflow-hidden p-6 sm:p-10 md:p-12 lg:p-20">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-start">
              <div className="w-full lg:w-1/3 space-y-10">
                <div className="space-y-4">
                  ...
                  <p className="font-serif text-foreground/80 text-base">
                    TEL：0742-42-6986
                  </p>
                  <a 
              ...
              <div className="w-full lg:flex-1 h-[250px] md:h-[380px] lg:h-[450px] bg-white shadow-inner border border-border/40 overflow-hidden">
                <iframe
